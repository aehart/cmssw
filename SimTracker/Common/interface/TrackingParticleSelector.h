...
public:
  ...
  bool operator()(const TrackingParticle &tp, const bool checkedROI = false) const { return select(&tp, checkedROI); }
  bool operator()(const TrackingParticle *tp, const bool checkedROI = false) const { return select(tp, checkedROI); }

  bool select(const TrackingParticle *tp, const bool checkedROI) const {
