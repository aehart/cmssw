...
modulesLabel  ['Clusterizer'] = cms.vstring( 'lowPtTripletStepClusters', 'pixelPairStepClusters', 'detachedTripletStepClusters', 'mixedTripletStepClusters', 'pixelLessStepClusters', 'tobTecStepClusters', 'exoRegionalStepClusters' ) # TrackClusterRemover
...
modulesLabel  ['Seeding'] = cms.vstring( 'initialStepSeeds', 'lowPtTripletStepSeeds', 'pixelPairStepSeeds', 'detachedTripletStepSeeds', 'mixedTripletStepSeedsA', 'mixedTripletStepSeedsB', 'mixedTripletStepSeeds', 'pixelLessStepSeeds', 'tobTecStepSeeds', 'exoRegionalStepSeeds', 'photonConvTrajSeedFromSingleLeg')
...
modulesLabel  ['TrackCandidate'] = cms.vstring( 'initialStepTrackCandidates', 'lowPtTripletStepTrackCandidates', 'pixelPairStepTrackCandidates', 'detachedTripletStepTrackCandidates', 'mixedTripletStepTrackCandidates', 'pixelLessStepTrackCandidates', 'tobTecStepTrackCandidates', 'exoRegionalStepTrackCandidates', 'convTrackCandidates' )
...
modulesLabel  ['TrackFinder'] = cms.vstring( 'pixelTracks', 'initialStepTracks', 'lowPtTripletStepTracks', 'pixelPairStepTracks', 'detachedTripletStepTracks', 'mixedTripletStepTracks', 'pixelLessStepTracks', 'tobTecStepTracks', 'exoRegionalStepTracks', 'generalTracks' )
...
modulesLabel  ['IterTracking'] = cms.vstring(
       ...
       'tobTecStepTrackCandidates_iter6',
       'tobTecStepTracks_iter6',
       'exoRegionalStepSeeds_iter6',
       'exoRegionalStepTrackCandidates_iter6',
       'exoRegionalStepTracks_iter6',
)
